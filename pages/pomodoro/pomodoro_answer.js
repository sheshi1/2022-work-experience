...
const updateHtml = () => {
  ...
  if (isBreakTime) {
    document.getElementById("work-time").classList.add("hidden");
  ...
  if (!isBreakTime) {
    document.getElementById("break-time").classList.add("hidden");
    document.getElementById("work-time").classList.remove("hidden");
  }
};
